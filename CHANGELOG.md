...
### Added
- **"Hide Buttons" checkbox** for compact window mode
  - Allows window to be resized much smaller
  - Persisted to INI file
  - Always visible for easy toggling
### Notes
- No changes to core monitoring functionality
- Fully backward compatible with existing settings
This release adds **UI flexibility** by allowing users to collapse the button
row for a minimal monitoring window.
---
## [v2.3.13] – 2026-01-17
### UI Cleanup Release
### Removed
